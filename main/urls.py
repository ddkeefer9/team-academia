...
urlpatterns = [
    ...
    path("assistant/degreecomparison", degree_comparison_view.DegreeCompPage.display_degree_comp, name="degreecomparison"),
    path("assistant/historical", historical_view.HistoricalPage.display_historical, name="historical"),
